...
class Index extends BaseMall {
    ...
    private function getIndexData()
    {
        ...
        if (empty($index_data)) {
            $index_data = array();
            $index_data['recommend_list'] = model('goods')->getGoodsOnlineList(array('goods_commend' => 1), 'goods_id,goods_name,goods_advword,goods_image,goods_promotion_price,goods_price', 0, 'rand()',6,'goods_commonid');
            //限时折扣
