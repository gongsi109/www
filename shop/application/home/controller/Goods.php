...
class Goods extends BaseGoods {
    ...
    public function index() {
       ...
       // halt($goods_info);
        ...
        //推荐商品 
        $goods_commend_list = $goods_model->getGoodsOnlineList(array( 'goods_commend' => 1), 'goods_id,goods_name,goods_advword,goods_image,goods_price', 0, 'rand()', 5, 'goods_commonid');
    ...
    public function arrival_notice_submit() {
        ...
        $goods_id = intval(input('post.goods_id'));
        if ($goods_id <= 0) {
            ds_show_dialog(lang('param_error'), 'reload');
        }
        // 验证商品数是否充足
