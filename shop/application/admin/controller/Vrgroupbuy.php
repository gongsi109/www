    ...
    public function groupbuy_add_vr() {
        if (!request()->isPost()) {
            ...
            if ($param['groupbuy_upper_limit'] > 0 && $goods_info['virtual_limit'] > 0 && $param['groupbuy_upper_limit'] > $goods_info['virtual_limit']) {
                ds_show_dialog(sprintf(lang('virtual_panic_buying'), $param['groupbuy_upper_limit'], $goods_info['virtual_limit']), url('Vrgroupbuy/index'));
            }
            ...
            if ($result) {
                ...
                ds_show_dialog(lang('groupbuy_add_success'), url('Vrgroupbuy/index'), 'succ');
            } else {
                ds_show_dialog(lang('groupbuy_add_fail'), url('Vrgroupbuy/index'));
            }
        }
    }
